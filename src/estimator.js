...
const covid19ImpactEstimator = (data = {}) => {
  ...
  const impactSevCBRT = impIBRT;
  const sevSevCBRT = sevIBRT;
  const iHospitalBedByReqTime = totalHospitalBeds * impactSevCBRT;
  const sHospitalBedByReqTime = totalHospitalBeds * sevSevCBRT;
  return {
    data: { data },
    impact: {
